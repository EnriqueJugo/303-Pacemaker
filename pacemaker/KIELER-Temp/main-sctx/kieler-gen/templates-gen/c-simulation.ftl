...
void receiveVariables() {
    ...
    if(root != NULL) {
        ...
        if(item != NULL) {
            ${tickdata_name}._g103_e3 = item->valueint;
        }
        // Receive _g104
        ...
        if(item != NULL) {
            ${tickdata_name}._g104_e1 = item->valueint;
        }
        // Receive _g106
        ...
        if(item != NULL) {
            ${tickdata_name}._g121_e1 = item->valueint;
        }
        // Receive _g125
        ...
        if(item != NULL) {
            ${tickdata_name}._g143_e1 = item->valueint;
        }
        // Receive _g145
        ...
        if(item != NULL) {
            ${tickdata_name}._g149_e2 = item->valueint;
        }
        // Receive _g15
        ...
        if(item != NULL) {
            ${tickdata_name}._g157_e3 = item->valueint;
        }
        // Receive _g159
        ...
        if(item != NULL) {
            ${tickdata_name}._g163_e1 = item->valueint;
        }
        // Receive _g167
        ...
        if(item != NULL) {
            ${tickdata_name}._g167_e2 = item->valueint;
        }
        // Receive _g17
        ...
        if(item != NULL) {
            ${tickdata_name}._g172_e3 = item->valueint;
        }
        // Receive _g174
        ...
        if(item != NULL) {
            ${tickdata_name}._g39_e1 = item->valueint;
        }
        // Receive _g4
        ...
        if(item != NULL) {
            ${tickdata_name}._g47_e2 = item->valueint;
        }
        // Receive _g48
        ...
        if(item != NULL) {
            ${tickdata_name}._g54_e1 = item->valueint;
        }
        // Receive _g55
        ...
        if(item != NULL) {
            ${tickdata_name}._g64_e2 = item->valueint;
        }
        // Receive _g65
        ...
        if(item != NULL) {
            ${tickdata_name}._g88_e1 = item->valueint;
        }
        // Receive _g9
        ...
        if(item != NULL) {
            ${tickdata_name}._pg114 = item->valueint;
        }
        // Receive _pg115
        ...
        if(item != NULL) {
            ${tickdata_name}._pg163_e1 = item->valueint;
        }
        // Receive _pg171
        ...
        if(item != NULL) {
            ${tickdata_name}._pg172_e3 = item->valueint;
        }
        // Receive _pg174
        ...
        if(item != NULL) {
            ${tickdata_name}._pg47_e2 = item->valueint;
        }
        // Receive _pg48
...
void sendVariables(int send_interface) {
    ...
    // Send _g103_e3
    cJSON_AddItemToObject(root, "_g103_e3", cJSON_CreateBool(${tickdata_name}._g103_e3));
    // Send _g104
    cJSON_AddItemToObject(root, "_g104", cJSON_CreateBool(${tickdata_name}._g104));
    // Send _g104_e1
    cJSON_AddItemToObject(root, "_g104_e1", cJSON_CreateBool(${tickdata_name}._g104_e1));
    // Send _g106
    ...
    // Send _g121_e1
    cJSON_AddItemToObject(root, "_g121_e1", cJSON_CreateBool(${tickdata_name}._g121_e1));
    // Send _g125
    ...
    // Send _g143_e1
    cJSON_AddItemToObject(root, "_g143_e1", cJSON_CreateBool(${tickdata_name}._g143_e1));
    // Send _g145
    ...
    // Send _g149_e2
    cJSON_AddItemToObject(root, "_g149_e2", cJSON_CreateBool(${tickdata_name}._g149_e2));
    // Send _g15
    ...
    // Send _g157_e3
    cJSON_AddItemToObject(root, "_g157_e3", cJSON_CreateBool(${tickdata_name}._g157_e3));
    // Send _g159
    ...
    // Send _g163_e1
    cJSON_AddItemToObject(root, "_g163_e1", cJSON_CreateBool(${tickdata_name}._g163_e1));
    // Send _g167
    cJSON_AddItemToObject(root, "_g167", cJSON_CreateBool(${tickdata_name}._g167));
    // Send _g167_e2
    cJSON_AddItemToObject(root, "_g167_e2", cJSON_CreateBool(${tickdata_name}._g167_e2));
    // Send _g17
    ...
    // Send _g172_e3
    cJSON_AddItemToObject(root, "_g172_e3", cJSON_CreateBool(${tickdata_name}._g172_e3));
    // Send _g174
    ...
    // Send _g39_e1
    cJSON_AddItemToObject(root, "_g39_e1", cJSON_CreateBool(${tickdata_name}._g39_e1));
    // Send _g4
    ...
    // Send _g47_e2
    cJSON_AddItemToObject(root, "_g47_e2", cJSON_CreateBool(${tickdata_name}._g47_e2));
    // Send _g48
    ...
    // Send _g54_e1
    cJSON_AddItemToObject(root, "_g54_e1", cJSON_CreateBool(${tickdata_name}._g54_e1));
    // Send _g55
    ...
    // Send _g64_e2
    cJSON_AddItemToObject(root, "_g64_e2", cJSON_CreateBool(${tickdata_name}._g64_e2));
    // Send _g65
    ...
    // Send _g88_e1
    cJSON_AddItemToObject(root, "_g88_e1", cJSON_CreateBool(${tickdata_name}._g88_e1));
    // Send _g9
    ...
    // Send _pg114
    cJSON_AddItemToObject(root, "_pg114", cJSON_CreateBool(${tickdata_name}._pg114));
    // Send _pg115
    ...
    // Send _pg163_e1
    cJSON_AddItemToObject(root, "_pg163_e1", cJSON_CreateBool(${tickdata_name}._pg163_e1));
    // Send _pg171
    cJSON_AddItemToObject(root, "_pg171", cJSON_CreateBool(${tickdata_name}._pg171));
    // Send _pg172_e3
    cJSON_AddItemToObject(root, "_pg172_e3", cJSON_CreateBool(${tickdata_name}._pg172_e3));
    // Send _pg174
    ...
    // Send _pg47_e2
    cJSON_AddItemToObject(root, "_pg47_e2", cJSON_CreateBool(${tickdata_name}._pg47_e2));
    // Send _pg48
