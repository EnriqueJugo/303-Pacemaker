...
void receiveVariables() {
    ...
    if(root != NULL) {
        ...
        if(item != NULL) {
            model._cg160 = item->valueint;
        }
        // Receive _cg162
        item = cJSON_GetObjectItemCaseSensitive(root, "_cg162");
        if(item != NULL) {
            model._cg162 = item->valueint;
        }
        // Receive _cg164
        ...
        if(item != NULL) {
            model._cg176 = item->valueint;
        }
        // Receive _cg178
        item = cJSON_GetObjectItemCaseSensitive(root, "_cg178");
        if(item != NULL) {
            model._cg178 = item->valueint;
        }
        // Receive _cg18
        ...
        if(item != NULL) {
            model._pg141 = item->valueint;
        }
        // Receive _pg144
        item = cJSON_GetObjectItemCaseSensitive(root, "_pg144");
        if(item != NULL) {
            model._pg144 = item->valueint;
        }
        // Receive _pg149
...
void sendVariables(int send_interface) {
    ...
    // Send _cg103
    cJSON_AddItemToObject(root, "_cg103", cJSON_CreateBool(model._cg103));
    // Send _cg104
    ...
    // Send _cg137
    cJSON_AddItemToObject(root, "_cg137", cJSON_CreateBool(model._cg137));
    // Send _cg139
    ...
    // Send _cg160
    cJSON_AddItemToObject(root, "_cg160", cJSON_CreateBool(model._cg160));
    // Send _cg162
    cJSON_AddItemToObject(root, "_cg162", cJSON_CreateBool(model._cg162));
    // Send _cg164
    ...
    // Send _cg176
    cJSON_AddItemToObject(root, "_cg176", cJSON_CreateBool(model._cg176));
    // Send _cg178
    cJSON_AddItemToObject(root, "_cg178", cJSON_CreateBool(model._cg178));
    // Send _cg18
    cJSON_AddItemToObject(root, "_cg18", cJSON_CreateBool(model._cg18));
    // Send _cg180
    cJSON_AddItemToObject(root, "_cg180", cJSON_CreateBool(model._cg180));
    // Send _cg182
    cJSON_AddItemToObject(root, "_cg182", cJSON_CreateBool(model._cg182));
    // Send _cg185
    cJSON_AddItemToObject(root, "_cg185", cJSON_CreateBool(model._cg185));
    // Send _cg188
    cJSON_AddItemToObject(root, "_cg188", cJSON_CreateBool(model._cg188));
    // Send _cg189
    cJSON_AddItemToObject(root, "_cg189", cJSON_CreateBool(model._cg189));
    // Send _cg19
    ...
    // Send _g105_e2
    cJSON_AddItemToObject(root, "_g105_e2", cJSON_CreateBool(model._g105_e2));
    // Send _g106
    ...
    // Send _g114_e3
    cJSON_AddItemToObject(root, "_g114_e3", cJSON_CreateBool(model._g114_e3));
    // Send _g115
    cJSON_AddItemToObject(root, "_g115", cJSON_CreateBool(model._g115));
    // Send _g115_e1
    cJSON_AddItemToObject(root, "_g115_e1", cJSON_CreateBool(model._g115_e1));
    // Send _g117
    ...
    // Send _g118_e2
    cJSON_AddItemToObject(root, "_g118_e2", cJSON_CreateBool(model._g118_e2));
    // Send _g12
    ...
    // Send _g132_e1
    cJSON_AddItemToObject(root, "_g132_e1", cJSON_CreateBool(model._g132_e1));
    // Send _g133
    ...
    // Send _g138_e2
    cJSON_AddItemToObject(root, "_g138_e2", cJSON_CreateBool(model._g138_e2));
    // Send _g139
    ...
    // Send _g148_e3
    cJSON_AddItemToObject(root, "_g148_e3", cJSON_CreateBool(model._g148_e3));
    // Send _g149
    ...
    // Send _g152_e1
    cJSON_AddItemToObject(root, "_g152_e1", cJSON_CreateBool(model._g152_e1));
    // Send _g156
    ...
    // Send _g157_e1
    cJSON_AddItemToObject(root, "_g157_e1", cJSON_CreateBool(model._g157_e1));
    // Send _g158
    ...
    // Send _g163_e2
    cJSON_AddItemToObject(root, "_g163_e2", cJSON_CreateBool(model._g163_e2));
    // Send _g164
    ...
    // Send _g173_e3
    cJSON_AddItemToObject(root, "_g173_e3", cJSON_CreateBool(model._g173_e3));
    // Send _g175
    ...
    // Send _g181_e2
    cJSON_AddItemToObject(root, "_g181_e2", cJSON_CreateBool(model._g181_e2));
    // Send _g182
    cJSON_AddItemToObject(root, "_g182", cJSON_CreateBool(model._g182));
    // Send _g185
    cJSON_AddItemToObject(root, "_g185", cJSON_CreateBool(model._g185));
    // Send _g186
    ...
    // Send _g187_e3
    cJSON_AddItemToObject(root, "_g187_e3", cJSON_CreateBool(model._g187_e3));
    // Send _g189
    cJSON_AddItemToObject(root, "_g189", cJSON_CreateBool(model._g189));
    // Send _g190
    cJSON_AddItemToObject(root, "_g190", cJSON_CreateBool(model._g190));
    // Send _g191
    cJSON_AddItemToObject(root, "_g191", cJSON_CreateBool(model._g191));
    // Send _g199
    cJSON_AddItemToObject(root, "_g199", cJSON_CreateBool(model._g199));
    // Send _g20
    cJSON_AddItemToObject(root, "_g20", cJSON_CreateBool(model._g20));
    // Send _g207
    cJSON_AddItemToObject(root, "_g207", cJSON_CreateBool(model._g207));
    // Send _g22
    ...
    // Send _g33_e3
    cJSON_AddItemToObject(root, "_g33_e3", cJSON_CreateBool(model._g33_e3));
    // Send _g34
    ...
    // Send _g50_e1
    cJSON_AddItemToObject(root, "_g50_e1", cJSON_CreateBool(model._g50_e1));
    // Send _g51
    ...
    // Send _g65_e1
    cJSON_AddItemToObject(root, "_g65_e1", cJSON_CreateBool(model._g65_e1));
    // Send _g66
    ...
    // Send _g75_e2
    cJSON_AddItemToObject(root, "_g75_e2", cJSON_CreateBool(model._g75_e2));
    // Send _g76
    ...
    // Send _pg114_e3
    cJSON_AddItemToObject(root, "_pg114_e3", cJSON_CreateBool(model._pg114_e3));
    // Send _pg115
    cJSON_AddItemToObject(root, "_pg115", cJSON_CreateBool(model._pg115));
    // Send _pg117
    cJSON_AddItemToObject(root, "_pg117", cJSON_CreateBool(model._pg117));
    // Send _pg12
    ...
    // Send _pg135
    cJSON_AddItemToObject(root, "_pg135", cJSON_CreateBool(model._pg135));
    // Send _pg14
    cJSON_AddItemToObject(root, "_pg14", cJSON_CreateBool(model._pg14));
    // Send _pg141
    cJSON_AddItemToObject(root, "_pg141", cJSON_CreateBool(model._pg141));
    // Send _pg144
    cJSON_AddItemToObject(root, "_pg144", cJSON_CreateBool(model._pg144));
    // Send _pg149
    cJSON_AddItemToObject(root, "_pg149", cJSON_CreateBool(model._pg149));
    // Send _pg151
    cJSON_AddItemToObject(root, "_pg151", cJSON_CreateBool(model._pg151));
    // Send _pg158
    cJSON_AddItemToObject(root, "_pg158", cJSON_CreateBool(model._pg158));
    // Send _pg189
    cJSON_AddItemToObject(root, "_pg189", cJSON_CreateBool(model._pg189));
    // Send _pg190
    cJSON_AddItemToObject(root, "_pg190", cJSON_CreateBool(model._pg190));
    // Send _pg191
    cJSON_AddItemToObject(root, "_pg191", cJSON_CreateBool(model._pg191));
    // Send _pg3
    ...
    // Send _pg50_e1
    cJSON_AddItemToObject(root, "_pg50_e1", cJSON_CreateBool(model._pg50_e1));
    // Send _pg51
    ...
    // Send _pg76
    cJSON_AddItemToObject(root, "_pg76", cJSON_CreateBool(model._pg76));
    // Send _pg78
    ...
    // Send _pg89
    cJSON_AddItemToObject(root, "_pg89", cJSON_CreateBool(model._pg89));
    // Send _pg9
    ...
    // Send _pre_VS
    cJSON_AddItemToObject(root, "_pre_VS", cJSON_CreateBool(model._pre_VS));
    // Send _reg_VP
    cJSON_AddItemToObject(root, "_reg_VP", cJSON_CreateBool(model._reg_VP));
    // Send _reg_VS
    cJSON_AddItemToObject(root, "_reg_VS", cJSON_CreateBool(model._reg_VS));
